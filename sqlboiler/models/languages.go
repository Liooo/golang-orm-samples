...
func (o *Language) Pilots(mods ...qm.QueryMod) pilotQuery {
	...
	queryMods = append(queryMods,
		qm.InnerJoin("\"pilots_languages\" on \"pilots\".\"id\" = \"pilots_languages\".\"pilot_id\""),
		qm.Where("\"pilots_languages\".\"language_id\"=?", o.ID),
	)
...
func (languageL) LoadPilots(ctx context.Context, e boil.ContextExecutor, singular bool, maybeLanguage interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.Select("\"pilots\".id, \"pilots\".name, \"pilots\".created_at, \"pilots\".updated_at, \"a\".\"language_id\""),
		qm.From("\"pilots\""),
		qm.InnerJoin("\"pilots_languages\" as \"a\" on \"pilots\".\"id\" = \"a\".\"pilot_id\""),
...
func (o *Language) AddPilots(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Pilot) error {
	...
	for _, rel := range related {
		query := "insert into \"pilots_languages\" (\"language_id\", \"pilot_id\") values ($1, $2)"
...
func (o *Language) SetPilots(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Pilot) error {
	query := "delete from \"pilots_languages\" where \"language_id\" = $1"
...
func (o *Language) RemovePilots(ctx context.Context, exec boil.ContextExecutor, related ...*Pilot) error {
	...
	var err error
	query := fmt.Sprintf(
		"delete from \"pilots_languages\" where \"language_id\" = $1 and \"pilot_id\" in (%s)",
